...
// 실제 service_role key (eyJ로 시작하는 JWT 토큰)
const SUPABASE_SERVICE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imh2bWR3a3VncHZxaWdwZmRmcnZ6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczMjgwNzYxMiwiZXhwIjoyMDQ4MzgzNjEyfQ.JPKnqpdyt3Pu0ciMp1QUdw_Chfsn-CLdfn7RfACZvPU';
...
async function migrateData() {
  ...
  for (let i = 0; i < analyses.length; i++) {
    ...
    try {
      // 중복 확인 (PostgreSQL에서는 single() 실패 시 오류 발생하므로 maybeSingle() 사용)
